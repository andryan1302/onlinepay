                ...
                <form action="#" id="form" class="form-horizontal" name="formnih">
                    ...
                    <div class="form-body">
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <!-- <div class="col-md-9"> -->
                                <input type="hidden" name="job" class="form-control" placeholder="Job title" value="siswa">
                                <!-- <span class="help-block"></span> -->
                            <!-- </div> -->
                        <!-- </div> -->
                        <div class="form-group">
...
$(document).ready(function() {
    ...
    dom:"Blfrtip",
        ...
        "ajax": {
            "url": "<?php echo site_url('inputmurid/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('inputmurid/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('inputmurid/ajax_add')?>";
    } else {
        url = "<?php echo site_url('inputmurid/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('inputmurid/ajax_delete')?>/"+id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
